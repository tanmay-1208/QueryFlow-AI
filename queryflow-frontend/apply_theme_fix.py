...
def patch_file(filepath):
    ...
    content = re.sub(r'border-\[\#4182ff\]/20', 'border    content = re.sub(r'border-\[\ent = re.sub(r'border-\[\#4182ff\]', 'border-[#C9    content = re.sub(r'border-\[\#4182ff\]/20', 'bont = re.sub(r'text-\[\#00ff88\]',     content = re.sub(ten    content = re.sub(r'border-[\#00ff88\]/10', 'bg-[#2ECC8A]/10', content)
    ...
    content = re.sub(r'border-red-500', 'border-[#E    content = re.sub(r'border-red-500', 'border-[#E    content = re.sub(r'border-red-500ding='utf-8') as f:
            f.write(content)
