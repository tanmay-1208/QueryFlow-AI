...
const LandingPage = () => (
  <div className="bg-[#0e0e0e] text-white font-['Inter']">
    ...
    {/* Wrap Hero in a fade-in motion div */}
    <motion.div 
    ...
    <section className="max-w-[1400px] mx-auto px-10 py-32 border-t border-white/5">
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        ...
        <motion.div 
          ...
          className="bg-[#131313] p-10 rounded-[4rem] border border-white/5 aspect-square flex items-center justify-center"
        >
           <div className="text-center">
             <motion.div 
               animate={{ scale: [1, 1.1, 1] }} 
               transition={{ duration: 2, repeat: Infinity }}
               className="text-6xl font-black text-[#4182ff] mb-4"
             >
               94%
             </motion.div>
