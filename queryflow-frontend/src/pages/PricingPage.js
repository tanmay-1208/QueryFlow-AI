  ...
  return (
    <div className="bg-[#080A0F] min-h-screen text-white pt-32 md:pt-40 overflow-x-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 pb-40 text-center">
        ...
        >
          SELECT YOUR <br className="block md:hidden" /><span className="text-[#C9A84C]">TIER</span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className={`p-8 md:p-6 md:p-10 rounded-[2.5rem] border transition-all ${plan.featured ? 'border-[#C9A84C] bg-[#0D1117] shadow-[0_0_30px_rgba(65,130,255,0.1)]' : 'border-white/5 bg-[#080A0F]'}`}
            >
