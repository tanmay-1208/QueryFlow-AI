const SkeletonCard = () => (
  <div className="bg-[#0D1117] p-6 rounded-[2.5rem] border border-white/5 shadow-xl animate-pulse">
    ...
    <div className="flex justify-between items-center bg-[#0D1117]/80 border border-[#C9A84C]/15 px-5 py-3 rounded-2xl mb-6 border border-white/5">
