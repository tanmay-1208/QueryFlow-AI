    ...
    public String handleChat(@RequestBody Map<String, Object> payload) {
        try {
            ...
            return builder.build()
                    .prompt()
                    .system(s -> s.text(
                        "You are VaultCA, an elite personal Chartered Accountant and financial advisor " +
                        "embedded in the QueryFlow Vault system. You have full access to the operator's " +
                        "inventory, portfolio, and financial data. \n\n" +
